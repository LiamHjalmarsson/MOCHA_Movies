...
export async function showAllMovies(moviegenre, counter){
    ...
    let rqstGenre = new Request("https://api.themoviedb.org/3/genre/movie/list?api_key=e666c096bb904490508ada0b495d2d90&language=en-US")
    ...
    let rqstMovies = new Request(`https://api.themoviedb.org/3/discover/movie?api_key=e666c096bb904490508ada0b495d2d90&language=en-UShttps://api.themoviedb.org/3/discover/movie?api_key=e666c096bb904490508ada0b495d2d90&language=en-US&with_genres=${moviegenre}page=${counter}`)
...
async function getMoviesAndSortAfterGenre(genreID, counter){
    let requestGenreMovies = new Request(`https://api.themoviedb.org/3/discover/movie?api_key=e666c096bb904490508ada0b495d2d90&language=en-US&with_genres=${genreID}&page=${counter}`)
...
async function createShowMore(genreID, counter){
  ...
  // this is a function that observe btn, if whole btn is fully vissible on screen dvs, (btnEntrie.isIntersecting == true) then more movies will load to page
    ...
    counter++;
    let rqst = new Request(`https://api.themoviedb.org/3/discover/movie?api_key=e666c096bb904490508ada0b495d2d90&language=en-US&with_genres=${genreID}&page=${counter}`)
    console.log(rqst)
